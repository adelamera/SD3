...
public class GetLabFrame {

	public static void getLab() {
		...
		final JTextArea lab = new JTextArea();
		lab.setBounds(10, 100, 200, 200);
		lab.setVisible(false);
		listScrollPane.add(lab);
		...
		get.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				lab.setText(HttpLab.getLab(Long.valueOf(id.getText())).toString());
				lab.setVisible(true);
			}
