...
public class GetAssignmentFrame {

	public static void getAssignment() {
		...
		assignment.setBounds(10, 100, 200, 200);
		assignment.setVisible(false);
		listScrollPane.add(assignment);
		...
		get.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				assignment.setText(HttpAssignment.getAssignment(Long.valueOf(id.getText())).toString());
